...
/// History page showing past extraction jobs
...
class _HistoryPageState extends ConsumerState<HistoryPage> {
  ...
  Widget _buildTopBar(BuildContext context, bool isDark, HistoryState historyState) {
    return Container(
      ...
      child: Row(
        children: [
          ...
          SoftIconButton(
            ...
            onPressed: () => ref.read(historyProvider.notifier).toggleSort(),
          ),
  ...
  Widget _buildHistoryList(bool isDark, HistoryState historyState) {
  ...
  Widget _buildHistoryItem(bool isDark, HistoryItem item) {
